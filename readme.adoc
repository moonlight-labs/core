...
* add @groovestack/accounting pkg `yarn add @groovestack/accounting`
...
* add @groovestack/jobs pkg `yarn add @groovestack/jobs`
* ensure peer dependencies are installed
...
* add @groovestack/comments pkg `yarn add @groovestack/comments`
* ensure peer dependencies are installed
...
* add @groovestack/versions `yarn add @groovestack/versions`
* ensure peer dependencies are installed
